...
export default function Privacy() {
  return (
    <div className="min-h-screen bg-background">
      <SeoHead
        title="Privacy Notice — ScaleBiz"
        description="How ScaleBiz collects, uses, and protects personal data across its AI sales engagement platform."
        path="/privacy"
      />
      ...
      <main className="container mx-auto px-6 py-12 max-w-3xl">
        ...
        <p>This service ("ScaleBiz", "we", "us") is operated by <strong>ScaleBiz</strong>, the legal entity providing the ScaleBiz platform. ScaleBiz acts as the <strong>data controller</strong> for personal data processed through the service. For privacy questions, contact us through in-app support.</p>
        ...
        <p>For privacy questions or to exercise your rights, contact ScaleBiz at <a className="underline" href="mailto:support@engageiqlk.com">support@engageiqlk.com</a> or by post:</p>

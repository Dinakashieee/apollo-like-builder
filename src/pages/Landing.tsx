...
const comparisons = [
  {
    ...
    competitor: "HubSpot",
    tagline: "vs. ScaleBiz",
    headline: "Why teams pick ScaleBiz over HubSpot",
    summary:
      "HubSpot is a powerful all-in-one CRM, but most sales teams use only 20% of its surface area — and pay for the other 80%. ScaleBiz is purpose-built for the outbound motion: signal, message, reply.",
    points: [
    ...
    verdict:
      "If you're a revenue team that lives in outbound, ScaleBiz ships the 20% you actually use — without the enterprise sticker shock.",
  },
  {
    id: "apollo",
    competitor: "Apollo.io",
    tagline: "vs. ScaleBiz",
    headline: "Why teams pick ScaleBiz over Apollo",
    summary:
      "Apollo is great at one thing: a big B2B contact database. But buying lists and blasting sequences is exactly the noise modern buyers tune out. ScaleBiz flips the model — wait for real signal, then reach out.",
    points: [
    ...
    verdict:
      "Stop spraying. ScaleBiz tells you when an account is actually worth a touch — and drafts the message that fits the moment.",
  },
  {
    id: "salesforce",
    competitor: "Salesforce",
    tagline: "vs. ScaleBiz",
    headline: "Why teams pick ScaleBiz over Salesforce",
    summary:
      "Salesforce is the system of record for the Fortune 500 — and it shows in setup time, admin cost, and consultant invoices. ScaleBiz is the system of action for teams that need to move this quarter.",
    points: [
    ...
    verdict:
      "Salesforce reports on what already happened. ScaleBiz helps you make this week's number.",
  },
  {
    id: "outreach",
    competitor: "Outreach / Salesloft",
    tagline: "vs. ScaleBiz",
    headline: "Why teams pick ScaleBiz over Outreach & Salesloft",
    summary:
      "Sequencers were built for the spray-and-pray era. ScaleBiz uses AI to suppress low-intent accounts and surface the ones that are actually buying — so reps spend their day on the right 10%.",
    points: [
    ...
    verdict:
      "ScaleBiz doesn't help you send more — it helps you send better, to the accounts that will actually reply.",
  },
];
...
const tiers: Tier[] = [
  {
    name: "Free",
    tagline: "Try ScaleBiz — no commitment",
    monthly: 0,
...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SeoHead
        title="ScaleBiz — Best AI Sales Platform & AI SDR for B2B Teams"
        description="ScaleBiz is the AI sales engagement platform and AI SDR for B2B teams — find accounts, write outreach, automate pipeline."
        path="/"
        jsonLd={[
          {
            ...
            mainEntity: [
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "ScaleBiz is a leading all-in-one AI sales engagement platform that combines target account discovery, AI cold email and WhatsApp outreach, lead intelligence, and pipeline automation in one workspace.",
                },
              },
              {
                "@type": "Question",
              ...
              },
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "ScaleBiz is the best Apollo alternative for teams that want AI-written outreach, WhatsApp, deal intelligence, and quarterly market trend refresh — not just contact data.",
                },
              },
            ],
          },
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="container relative mx-auto px-6 text-center max-w-4xl">
          ...
          >
            ...
            ScaleBiz tells you exactly which accounts match your business and only prompts
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-2xl mx-auto text-center mb-16">
            ...
            <p className="mt-4 text-muted-foreground text-lg">
              ScaleBiz replaces bulk outreach with precise, signal-driven selling — in seven simple steps.
            </p>
          </div>
      ...
      <section id="features" className="py-24">
        <div className="container mx-auto px-6">
          <div className="max-w-2xl mx-auto text-center mb-16">
            ...
            <p className="mt-4 text-muted-foreground text-lg">
              Replace 6 tools with one. ScaleBiz brings your data, your messaging,
      ...
      <section id="why-us" className="py-24 bg-slate-50/60 border-y border-slate-100">
        <div className="container mx-auto px-6">
          <div className="max-w-2xl mx-auto text-center mb-12">
            ...
            <h2 className="text-4xl lg:text-5xl font-display font-bold text-primary-deep tracking-tight">
              ScaleBiz vs. the rest
            </h2>
            <p className="mt-4 text-muted-foreground text-lg">
              Honest, head-to-head breakdowns of how ScaleBiz stacks up against the tools your team is probably already paying for.
            </p>
          </div>
                ...
                <article className="bg-white rounded-3xl border border-slate-100 shadow-sm p-8 lg:p-12">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                    <div className="hidden md:flex items-center gap-2 text-sm font-semibold text-primary-deep">
                      <CheckCircle2 className="h-4 w-4 text-primary" /> ScaleBiz
                    </div>
                  ...
                  <div className="mt-8 flex flex-wrap gap-3">
                    ...
                    >
                      Try ScaleBiz free <ArrowRight className="ml-2 h-4 w-4" />
                    </Button>
                    <Link to="/demo">
      ...
      <section id="customers" className="py-24 bg-gradient-deep text-primary-foreground relative overflow-hidden">
        ...
        <div className="container relative mx-auto px-6 max-w-4xl text-center">
          ...
          <blockquote className="text-2xl lg:text-3xl font-display font-medium leading-relaxed">
            "ScaleBiz tells me <span className="text-primary-glow">exactly which 5 leads</span> to
        ...
        <div className="container mx-auto px-6">
          <div className="card-elevated p-12 lg:p-16 text-center bg-gradient-soft border-2 border-primary/10 max-w-4xl mx-auto relative overflow-hidden">
            ...
            <p className="relative mt-4 text-lg text-muted-foreground max-w-xl mx-auto">
              Join early adopters using ScaleBiz to power their revenue engine — with full control of their data.
            </p>
        ...
        <div className="container mx-auto px-6 flex flex-col gap-6">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 text-xs text-muted-foreground border-t border-border/40 pt-6">
            <address className="not-italic leading-relaxed">
              <span className="font-semibold text-foreground">ScaleBiz</span><br />
            ...
            <p>© 2026 ScaleBiz. Built for revenue teams who refuse to settle.</p>
          </div>
        </div>
      </footer>

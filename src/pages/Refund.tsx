...
export default function Refund() {
  return (
    <div className="min-h-screen bg-background">
      <SeoHead
        title="Refund Policy — LeadengageIQ"
        description="LeadengageIQ's 14 working day refund window, cancellation rules, and how to request a refund via PayPal."
        path="/refund"
      />
      ...
      <main className="container mx-auto px-6 py-12 max-w-3xl">
        ...
        <p><strong>LeadengageIQ</strong> offers a refund window of <strong>14 working days</strong> from your initial order date. If you are not satisfied with your purchase, you may request a full refund within <strong>14 working days</strong> of placing your order.</p>

        <h2 className="text-xl font-display font-bold text-primary-deep mt-6">How to request a refund</h2>
        <p>Payments for LeadengageIQ are processed securely through <strong>PayPal</strong>. To request a refund:</p>
        <ul className="list-disc pl-6 space-y-1">
          <li>Contact LeadengageIQ through in-app support or email <a href="mailto:support@engageiqlk.com" className="underline">support@engageiqlk.com</a> with your PayPal transaction ID and the email address used at checkout.</li>

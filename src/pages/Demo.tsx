...
const perks = [
  { icon: Target, title: "Tailored walkthrough", desc: "We'll show how ScaleBiz fits your exact outbound motion." },
...
export default function Demo() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <SeoHead
        title="Book a Free Demo — ScaleBiz"
        description="See ScaleBiz in action. Book a free 30-minute walkthrough tailored to your outbound workflow."
        path="/demo"
      />
      ...
      <main className="container mx-auto px-6 py-16 grid md:grid-cols-2 gap-12 max-w-6xl">
        <section className="space-y-8">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight">
            See ScaleBiz run on <span className="bg-gradient-primary bg-clip-text text-transparent">your pipeline</span>
          </h1>
          ...
          {done ? (
            ...
            <form onSubmit={onSubmit} className="space-y-4">
              ...
              <p className="text-xs text-muted-foreground text-center">
                By submitting, you agree to be contacted about ScaleBiz. We never share your info.
              </p>
            </form>
          )}
        </section>

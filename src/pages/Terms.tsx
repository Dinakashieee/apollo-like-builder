...
export default function Terms() {
  return (
    <div className="min-h-screen bg-background">
      <SeoHead
        title="Terms of Service — LeadengageIQ"
        description="The terms governing your use of LeadengageIQ's AI sales engagement platform, including acceptable use and account responsibilities."
        path="/terms"
      />
      ...
      <main className="container mx-auto px-6 py-12 max-w-3xl">
        ...
        <p>These Terms of Service ("Terms") form a binding agreement between you and <strong>LeadengageIQ</strong> ("LeadengageIQ", "we", "us"), the legal entity that operates the LeadengageIQ platform (the "Service"). By creating an account, signing in, or otherwise using the Service, you agree to these Terms.</p>
        ...
        <p>LeadengageIQ provides a B2B revenue-intelligence platform, including lead and opportunity management, AI-generated insights, AI-assisted outbound email composition, and related tools. Specific features depend on the plan you subscribe to.</p>

        <h2 className="text-xl font-display font-bold text-primary-deep mt-6">4. Acceptable Use Policy</h2>
        <p>LeadengageIQ is a B2B revenue-intelligence and sales-enablement tool intended for legitimate, permission-based business outreach. It is <strong>not</strong> a bulk email, marketing-automation, or cold-mailing platform, and it must not be used to send spam.</p>
        <p><strong>Permitted use.</strong> You may use LeadengageIQ to:</p>
        ...
        <ul className="list-disc pl-6 space-y-1">
          ...
          <li>Use LeadengageIQ's email features for one-to-one human review and sending — not for automated mass blasts.</li>
        </ul>
        <p className="mt-3"><strong>You must NOT use LeadengageIQ to:</strong></p>
        <ul className="list-disc pl-6 space-y-1">
          ...
          <li>Send messages to consumers (B2C) without the legal basis required in their jurisdiction; LeadengageIQ is intended for B2B outreach only.</li>
        ...
        <p className="mt-3"><strong>Enforcement.</strong> You are solely responsible for the content and recipients of any communications you create or send using LeadengageIQ. We may investigate suspected violations, remove content, throttle or disable AI-generation features, suspend or terminate accounts without notice, and report unlawful activity to the relevant authorities. Repeated or serious violations will result in permanent termination.</p>

        <h2 className="text-xl font-display font-bold text-primary-deep mt-6">5. Your legal responsibility & compliance with law</h2>
        <p><strong>You are the data controller.</strong> When you upload, import, enrich, or process information about leads, prospects, or contacts in LeadengageIQ, <strong>you</strong> determine the purposes and means of that processing. You are therefore the "data controller" (under GDPR / UK GDPR) or the equivalent legally responsible party (under CCPA, PIPEDA, LGPD, and other applicable laws). LeadengageIQ acts only as a data <em>processor</em> on your behalf and processes data solely on your documented instructions, as set out in our <Link className="underline" to="/privacy">Privacy Notice</Link>.</p>
        ...
        <ul className="list-disc pl-6 space-y-1">
          ...
          <li>Honour <strong>opt-out, unsubscribe, erasure, access, and objection</strong> requests from your contacts promptly and at your own cost — these requests are your responsibility, not LeadengageIQ's.</li>
          ...
          <li>Not transfer LeadengageIQ's compliance obligations onto LeadengageIQ — we provide a tool; <strong>responsibility for how you use it rests with you</strong>.</li>
        </ul>
        <p className="mt-3"><strong>Indemnity for compliance failures.</strong> You agree to indemnify, defend, and hold LeadengageIQ harmless from any claim, fine, penalty, regulatory action, complaint, chargeback, or loss arising from (a) your breach of any law listed above, (b) the content or recipients of messages you send, (c) the data you upload or process, or (d) your failure to honour data-subject or unsubscribe requests.</p>
        ...
        <p>LeadengageIQ retains all right, title, and interest in and to the Service, including all software, documentation, branding, designs, and underlying technology. We grant you a limited, non-exclusive, non-transferable, revocable right to access and use the Service in accordance with these Terms and your subscription plan.</p>
        <p>You retain ownership of the content you upload ("Your Content"). You grant LeadengageIQ a limited, worldwide, royalty-free license to host, store, transmit, and process Your Content solely as necessary to provide the Service to you.</p>

        <h2 className="text-xl font-display font-bold text-primary-deep mt-6">8. AI-generated content</h2>
        <p>AI-generated suggestions are starting points — not guarantees. You are responsible for reviewing, editing, and verifying any AI output before relying on it, sending emails, or making business decisions. You must have the rights necessary for any content you submit as input to AI features. LeadengageIQ may apply content filters and may refuse, restrict, or remove outputs that violate these Terms or applicable law.</p>
        ...
        <p>The Service is provided "as is" and "as available". To the fullest extent permitted by law, LeadengageIQ disclaims all implied warranties, including merchantability, fitness for a particular purpose, and non-infringement.</p>

        <h2 className="text-xl font-display font-bold text-primary-deep mt-6">13. Limitation of liability</h2>
        <p>To the fullest extent permitted by law, LeadengageIQ's aggregate liability arising out of or in connection with these Terms is capped at the fees you paid to LeadengageIQ in the 12 months preceding the event giving rise to the claim. LeadengageIQ is not liable for indirect, incidental, special, consequential, or punitive damages, including loss of profits, data, goodwill, or business opportunity. Nothing in these Terms excludes liability that cannot be excluded by law (such as fraud or death/personal injury caused by negligence).</p>

        <h2 className="text-xl font-display font-bold text-primary-deep mt-6">14. Indemnification</h2>
        <p>You agree to indemnify and hold LeadengageIQ harmless from any claim, loss, or expense arising out of Your Content, your use of the Service, or your breach of these Terms.</p>
        ...
        <p>These Terms are governed by the laws of the jurisdiction in which LeadengageIQ is established, without regard to conflict-of-laws principles. Disputes will be resolved by the competent courts of that jurisdiction, unless mandatory consumer law provides otherwise.</p>

        <h2 className="text-xl font-display font-bold text-primary-deep mt-6">17. Contact</h2>
        <p>Questions about these Terms? Contact LeadengageIQ at <a className="underline" href="mailto:support@engageiqlk.com">support@engageiqlk.com</a> or by post:</p>
        <address className="not-italic mt-2 leading-relaxed">
          <strong>LeadengageIQ</strong><br />

...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const leads = [
      ...
      { company_name: "Helix Health", contact_name: "James Okafor", email: "j.okafor@helixhealth.io", role: "Head of Growth", industry: "Healthcare", country: "UK", status: "engaged", score: 91, source: "Inbound", pain_points: ["HIPAA compliance", "long sales cycles"], systems_in_use: ["HubSpot"] },
      ...
      { company_name: "Acme Robotics", contact_name: "Marc Dubois", email: "marc@acmerobotics.io", role: "VP Marketing", industry: "Industrial", country: "France", status: "engaged", score: 76, source: "Webinar", pain_points: ["niche TAM", "long demo cycle"], systems_in_use: ["Salesforce"] },
      ...
      { company_name: "Solace IoT", contact_name: "Hana Müller", email: "hana@solaceiot.de", role: "CMO", industry: "IoT", country: "Germany", status: "engaged", score: 79, source: "Inbound", pain_points: ["device-side analytics"], systems_in_use: ["HubSpot"] },
    ];
